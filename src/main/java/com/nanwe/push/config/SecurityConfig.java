        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/join","/reissue","/index.html",
                                "push_list.html", "push_detail.html", "push_create.html", "users.html",
                                "/swagger-ui/**",
                                "/v3/api-docs/**",
                                "/js/**", "/css/**"
                        ).permitAll()
        ...
        http
                .cors((corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:8082", "http://localhost:8081"));
